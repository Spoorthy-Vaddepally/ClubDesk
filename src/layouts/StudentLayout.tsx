...
const navItems = [
  ...
  { path: '/student/clubDirectory', icon: <Users size={20} />, label: 'Discover' },
  { path: '/student/my-clubs', icon: <Heart size={20} />, label: 'My Memberships' },
  { path: '/student/events', icon: <Calendar size={20} />, label: 'Events and Activities' },
                ...
                <div className="max-w-lg w-full">
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="Search for clubs, events, or notifications..."
                    />
                  </div>
                </div>
              </div>

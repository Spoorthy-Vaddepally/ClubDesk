          ...
          >
            <div className="flex justify-between items-center mb-6">
              ...
              <motion.div whileHover={{ x: 5 }}>
                <Link to="/club-head/events" className="text-sm font-medium text-primary-600 hover:text-primary-700 flex items-center">
                  View All Events
          ...
          >
            ...
            <div className="px-6 py-4 bg-gray-50 border-t border-gray-200">
              <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                <Link
                  to="/club/events/create"
                  className="inline-flex w-full items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-primary-600 hover:bg-primary-700 focus:outline-none"
                >
                  <Plus size={16} className="mr-2" />
                  Create New Event
                </Link>
